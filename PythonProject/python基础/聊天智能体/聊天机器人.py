...
#性别选择框
gender=st.selectbox(label='性别',options=['male','female','直升机'],index=0,key='gender')

#是否已婚单选框
st.radio(label='是否已婚',options=['yes','no'],horizontal=True,key='married')
